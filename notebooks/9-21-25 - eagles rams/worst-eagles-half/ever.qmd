...
# Philadelphia Eagles First Half Offensive Analysis - All Time
...
cache_data = 'pbp_all.parquet'
if (!file.exists(cache_data)) {
  pbp_all <- nflreadr::load_pbp(1999:2025)
  arrow::write_parquet(pbp_all, cache_data)
} else {
  pbp_all <- arrow::read_parquet(cache_data)
}
```
